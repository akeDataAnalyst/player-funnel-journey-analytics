...
player-funnel-journey-analytics
Player funnel, conversion & retention analytics for mobile games. Drop-off analysis, cohort tables, behavioral clustering + Streamlit dashboard.
#GameAnalytics #PlayerJourney #FunnelAnalysis #Retention #CohortAnalysis #Gaming #DataScience #Python #Streamlit #Clustering #MobileGames